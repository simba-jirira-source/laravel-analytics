...
- Keep package names, namespaces, Composer metadata, publish tags, documentation, and examples aligned with `simba-jirira-source/laravel-analytics`.
...
- Full validation: `composer verify`
